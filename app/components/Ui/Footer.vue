...
<template>
	<footer class="bg-green-50 border-t border-gray-200">
		<!-- Main Footer Content -->
		<div class="max-w-7xl mx-auto px-4 py-12">
			<div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 items-center">
				...
				<div class="flex items-center gap-2">
					...
					<span class="text-xl font-bold text-gray-900">playstat</span>
				</div>

				<!-- Links -->
				<div class="flex flex-wrap gap-6 md:justify-center">
					<a
						href="#"
				...
				<div class="flex gap-3 lg:justify-end">
					<a href="#" class="inline-block">
						<div
							class="bg-black rounded-lg px-3 py-2 flex items-center gap-2 hover:bg-gray-800 transition-colors"
						>
							<svg
